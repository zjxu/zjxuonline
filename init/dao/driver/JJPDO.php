...
class JJPDO
{
	 ...
	 * 构造函数
	 */
	function __construct($dbname=null,$user=null,$pass=null)
	{
			
		if(!isset($dbname)||$dbname==null)$dbname=JJDbConfig::$dbname;
		if(!isset($user)||$user==null)$user=JJDbConfig::$username;
		if(!isset($pass)||$pass==null)$pass=JJDbConfig::$password;
		$connection = new PDO(JJDbConfig::$pdotype.':host='.JJDbConfig::$host.';dbname='.$dbname,$user,$pass,
	 ...
	 * @param $dbname
	 */
	function changedb($dbname,$user="",$pass="")
	{
